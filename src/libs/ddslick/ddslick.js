(function (e) {
    ...
    var c = {}, d = {
        ...
        b = '<style id="css-ddslick" type="text/css">.dd-select{ background-color: transparent!important; width: 130px!important; position:relative; cursor:pointer;}.dd-desc { color:#aaa; display:block; overflow: hidden; font-weight:normal; line-height: 1.4em; }.dd-selected{ overflow:hidden; display:flex; align-items: center; column-gap: 5px; padding: 0 10px; color: white; font-family: "Lato", sans-serif;}.dd-pointer{ width:0; height:0; position:absolute; right:10px; top:50%; margin-top:-3px;}.dd-pointer-down{ border:solid 5px transparent; border-top:solid 5px #fff; }.dd-pointer-up{border:solid 5px transparent !important; border-bottom:solid 5px #fff !important; margin-top:-8px;}.dd-options{ border:solid 1px #ccc; border-top:none; list-style:none; box-shadow:0px 1px 5px #ddd; display:none; position:absolute; z-index:2000; margin:0; width: 130px!important; padding:0;overflow:auto;}.dd-option{ padding:10px; height: 70px; display:flex; align-items: center; column-gap: 5px; border-bottom:solid 1px #ddd; overflow:hidden; text-decoration:none; color:#333; cursor:pointer;-webkit-transition: all 0.25s ease-in-out; -moz-transition: all 0.25s ease-in-out;-o-transition: all 0.25s ease-in-out;-ms-transition: all 0.25s ease-in-out; }.dd-options > li:last-child > .dd-option{ border-bottom:none;}.dd-option:hover{ background:#f3f3f3; color:#000;}.dd-selected-description-truncated { text-overflow: ellipsis; white-space:nowrap; }.dd-option-selected { background:#f6f6f6; }.dd-option-image, .dd-selected-image { width: 50px; height: 50px; border-radius: 50%; }.dd-image-right { float:right; margin-right:15px; margin-left:5px;}.dd-container{ width: 130px!important; position:relative;}​ .dd-selected-text { font-weight:bold}​</style>';
    c.init = function (l) {
        var l = e.extend({}, d, l);
